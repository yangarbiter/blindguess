"""
https://github.com/MadryLab/spatial-pytorch/blob/master/robustness/attacker.py
"""
...
class Attacker(ch.nn.Module):
    ...
    def forward(self, x, target, tries, spatial_constraint, attack_type,
...
class AttackerModel(ch.nn.Module):
    ...
    def forward(self, inp, target=None, **attacker_kwargs):
        """
